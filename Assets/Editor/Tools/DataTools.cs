...
//     {
//         [MenuItem(CommonEditorMethod.CommonTitle + "生成配置文件")]
//         public static void ShowConfigToolUI() => "生成配置文件".ShowUI<ConfigTools>();
//
...
//             _content = GetConfig(sortingLayers);
//         }
//
//         /// <summary>
//         /// prefab
...
//         {
//             string[] temp = GetFilesPath($"{Application.dataPath}/Resources", "*.prefab");
//             _content = GetConfig(temp);
//         }
//
//         /// <summary>
//         /// Scene
...
//         {
//             string[] temp = GetFilesPath($"{Application.dataPath}", "*.unity");
//             _content = GetConfig(temp);
//         }
//
//         /// <summary>
...
//         /// <returns></returns>
//         private static string[] GetFilesPath(string path, string suffix)
//         {
...
//             {
//                 string tempC = c.ReplaceStr();
//                 sb.AppendLine($"\tpublic const string {tempC} = \"{c}\";");
//             }
//
