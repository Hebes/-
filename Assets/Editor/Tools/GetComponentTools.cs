...
public class GetComponentTools
{
    // #region 获取组件和变量
    //
    ...
    [MenuItem("GameObject/获取组件/Button", false, 1)]
    ...
    [MenuItem("GameObject/获取组件/TMP_Text", false, 1)]
    private static void GetComponent8() => GetComponent<TMP_Text>();
    [MenuItem("GameObject/获取组件/TextMeshProUGUI", false, 1)]
    private static void GetComponent9() => GetComponent<TextMeshProUGUI>();
